...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen bg-[#0a0a0a] text-zinc-50 flex flex-col relative pb-20 max-w-[480px] mx-auto shadow-2xl shadow-black/50 overflow-x-hidden`}
      >
        <ReactQueryProvider>
          <header className="sticky top-0 z-50 w-full bg-[#111111] border-b border-zinc-800/80">
            <div className="px-5 h-16 flex items-center justify-between">
              <Link href="/" className="font-bold flex items-center gap-2 hover:opacity-80 transition-opacity text-[#f08c5c]">
